...
void Scoring_Mech::neutral_stake_helper() {
    while(neutral_stake_rot.get_position()>33000){
        neutral_stake_mtr.move_velocity(50);
    }
    neutral_stake_mtr.move_velocity(0);
}

int Scoring_Mech::neutral_stake_helper_task() {
    scoring_mech.neutral_stake_helper();
    return 1;
}
void Scoring_Mech::neutral_stake2_helper() {
    while(neutral_stake_rot.get_position()>26000){
...
int Scoring_Mech::neutral_stake2_helper_task() {
    scoring_mech.neutral_stake2_helper();
    return 1;
}
void Scoring_Mech::neutral_stake3_helper() {
    while(neutral_stake_rot.get_position()>angle_positions[2]){
        neutral_stake_mtr.move_velocity(130);
    }
    neutral_stake_mtr.move_velocity(0);
    neutral_stake_rot.set_position(angle_positions[2]);
}

int Scoring_Mech::neutral_stake3_helper_task() {
    scoring_mech.neutral_stake3_helper();
    return 1;
}
void Scoring_Mech::intake_helper() {
    neutral_stake_rot.set_position(36000);
    pros::delay(650);
    intake_mtr.move_velocity(600);
    pros::delay(375);
...
int Scoring_Mech::intake_helper_task() {
    scoring_mech.intake_helper();
    return 1;
}
