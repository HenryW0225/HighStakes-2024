...
pros::Motor right_middle_mtr(5, pros::v5::MotorGears::blue, pros::v5::MotorUnits::degrees);
pros::Motor right_back_mtr(4, pros::v5::MotorGears::blue, pros::v5::MotorUnits::degrees);
