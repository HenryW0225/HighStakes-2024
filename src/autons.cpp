...
void redRightElim(){
  ...
  chassis.turn_to_point(18.5,-33,0,12,3,50,700);
  pros::delay(350);
  chassis.drive_to_point(18.5,-33,14,0,2,50,1050);
  pneumatics.doinker_right_v(1);
  pros::delay(110);
  chassis.turn_to_point(20,-50,0,14,3,50,350);
  chassis.drive_distance(5.5,9,2,50,450,0.515,0,0.5,0);
  pneumatics.doinker_left_v(1);
  pros::delay(105);
  chassis.turn_to_point(25,-50,0,14,3,50,350);
  chassis.drive_to_point(7,-7,14,0,2,50,1050);
  pneumatics.doinker_right_v(0);
  pneumatics.doinker_left_v(0);
  pros::delay(90);
  chassis.turn_to_point(29.5,-40,0,14,3,50,350);
  scoring_mech.intake_move(600);
  chassis.drive_distance(14,14,2,50,450,0.515,0,0.5,0);
  chassis.turn_to_point(-20,-100,0,14,2,50,350);
  chassis.drive_distance(14,14,2,50,500,0.515,0,0.5,0);
  pros::delay(600);
  chassis.turn_to_point(-27.5,-27,0,14,2,50,450);
  pros::Task neutralstake_task(Scoring_Mech::neutral_stake_helper_task);
  chassis.drive_to_point(-27.5,-27,14,0,2,50,1250);
  pros::delay(450);
  ...
  chassis.drive_to_point(-39.75,-39.85,12,0,1.5,50,1100);
}
...
void blueLeftElim() {
  ...
  pros::delay(50);
  pros::Task intake_task(Scoring_Mech::intake_helper_task);
  chassis.turn_to_point(-18.5,-33,0,14,3,50,675);
  pros::delay(325);
  chassis.drive_to_point(-18.5,-33,14,0,2,50,1050);
  pneumatics.doinker_left_v(1);
  pros::delay(105);
  ...
  pros::delay(150);
  chassis.turn_to_point(-25,-50,0,14,3,50,350);
  chassis.drive_to_point(7,-7,14,0,2,50,1100);
  pneumatics.doinker_right_v(0);
  pneumatics.doinker_left_v(0);
  pros::delay(90);
  chassis.turn_to_point(-20,-30,0,14,3,50,350);
  scoring_mech.intake_move(600);
  chassis.drive_distance(14,14,2,50,700,0.515,0,0.5,0);
  chassis.turn_to_point(20,-110,0,14,2,50,350);
  chassis.drive_distance(14.5,14,2,50,700,0.515,0,0.5,0);
  pros::delay(600);
  chassis.turn_to_point(28,-26.5,0,14,2,50,450);
  pros::Task neutralstake_task(Scoring_Mech::neutral_stake_helper_task);
  chassis.drive_to_point(28,-26.5,14,0,2,50,1250);
  pros::delay(400);
  chassis.turn_to_point(41,-40.5,0,14,3,50,450);
  pros::Task neutralstake2_task(Scoring_Mech::neutral_stake2_helper_task);
  chassis.set_brake_mode('C');
  pros::Task neutralstake3_task(Scoring_Mech::neutral_stake3_helper_task);
  chassis.drive_to_point(41,-40.5,12,0,1.5,50,1100);
