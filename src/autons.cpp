...
void redLeftElim(){
  ...
  chassis.set_coordinates(14.088, -4.959, 148.533);
  scoring_mech.move1(500);
  chassis.drive_to_point(17, -10, 12, 0, 2, 50, 750);
  pros::delay(100);
  scoring_mech.move1(0);
  chassis.drive_to_point(-8, 39.5, 6, 1, 2, 50, 1100);
  scoring_mech.move1(-600);
  pneumatics.clench_v(1);
  chassis.turn_to_point(-18, 39, 0, 8, 1.5, 100, 1000);
  scoring_mech.move1(0);
  scoring_mech.intake_move(600);
  chassis.drive_to_point(-18, 39, 10, 0);
  chassis.turn_to_point(-26, 39.5, 0, 12, 2, 10, 500);
  chassis.drive_to_point(-26, 39.5, 10, 0);
  chassis.turn_to_point(-24, 28, 0, 10, 2, 50, 1000);
  chassis.drive_to_point(-24, 28, 12, 0, 2.5, 50, 500);
  chassis.turn_to_point(-32, -8, 0, 12, 2, 50, 800);
  chassis.drive_to_point(-32, -8, 12, 0, 2, 50, 1000);
  chassis.turn_to_point(-48, -24, 0, 10, 2, 50, 1000);
  chassis.drive_to_point(-42, -18, 2, 0, 2, 50, 1000);
  chassis.drive_to_point(-25, -1, 10, 0);
  chassis.drive_to_point(-36, -12, 12, 0, 2, 50, 750);
  scoring_mech.intake_move(0);
  chassis.drive_to_point(-24, 0, 12, 0, 2.5, 50, 750);
