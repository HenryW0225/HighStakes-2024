...
void default_constants(){
  ...
  chassis.set_drive_exit_conditions(2, 40, 700);
  chassis.set_turn_exit_conditions(5, 40, 700);
  chassis.set_swing_exit_conditions(2, 40, 700);
}
...
void odom_constants(){
  ...
  chassis.drive_settle_time = 40;
  chassis.turn_max_voltage = 14;
  chassis.turn_kp = 0.31;
  chassis.turn_ki = 0;
  chassis.turn_kd = 2.5;
  chassis.turn_settle_error = 3.5;
  chassis.turn_settle_time = 40;
...
void redLeftElim(){
  ...
  chassis.set_coordinates(0, 0, 0);
  odom_constants();
  chassis.drive_to_point(0, -33, 6, 0);
  pros::delay(50);
  pneumatics.clench_v(1);
  chassis.turn_to_point(24, -60);
  pros::delay(10);
  intake.move(600);
  chassis.drive_to_point(17, -51);
  pros::delay(250);
  chassis.turn_to_point(24, -52);
  chassis.drive_to_point(24, -52);
  pros::delay(275);
  ...
  chassis.turn_to_point(-24, -48);
  pneumatics.clench_v(1);
  chassis.drive_to_point(-24, 8, 4, 0);
  intake.move(600);
