...
void redLeftQual(){
  ...
  chassis.drive_to_point(17, -10, 12, 0, 2.5, 50, 1000);
  //pros::delay(100);
  scoring_mech.move1(0);
  scoring_mech.set_brake_mode('C');
  chassis.drive_to_point(-8, 39.5, 6, 1, 2, 50, 1200);
  scoring_mech.set_brake_mode('H');
  scoring_mech.move1(-600);
  pneumatics.clench_v(1);
  pros::delay(100);
  chassis.turn_to_point(-18, 40, 0, 7, 1.5, 100, 1000);
  scoring_mech.move1(0);
  scoring_mech.intake_move(600);
  chassis.drive_to_point(-18, 40, 10, 0);
  chassis.turn_to_point(-24, 40, 0, 12, 2, 50, 100);
  chassis.drive_to_point(-24, 40, 10, 0);
  chassis.turn_to_point(-18, 26, 0, 10, 1.5, 100, 950);
  chassis.drive_to_point(-18, 26, 12, 0, 3, 10, 500);
  chassis.turn_to_point(10, 0);
  chassis.drive_to_point(10, 0);
  chassis.turn_to_point(24, 0);
  pros::delay(50);
  pneumatics.clench_v(0);
  chassis.drive_to_point(20, 0, 12, 0);
  chassis.drive_to_point(32, 0, 12, 0);
  scoring_mech.intake_move(8);
  chassis.turn_to_point(12, -24);
  chassis.drive_to_point(52, 24, 6, 0.25);
  pneumatics.clench_v(1);
  pros::delay(100);
  chassis.turn_to_point(72, 24, 0, 10, 1.5, 100, 1200);
  scoring_mech.intake_move(600);
  chassis.drive_to_point(72, 24, 12, 0);
  scoring_mech.set_brake_mode('H');
  pros::Task laddertouch_task(Scoring_Mech::neutral_stake_score_task);
  pros::delay(50);
  chassis.turn_to_point(0, 24);
  chassis.drive_to_point(40, 30, 5, 2);
  ...
  scoring_mech.intake_move(600);
  chassis.drive_to_point(-18, 40, 10, 0);
  chassis.turn_to_point(-24, 39.5, 0, 12, 2, 10, 100);
  pros::delay(150);
  chassis.drive_to_point(-24, 39.5, 10, 0);
  pros::delay(250);
  chassis.turn_to_point(-24, 28, 0, 10, 1.5, 100, 1000);
  chassis.drive_to_point(-24, 28, 12, 0, 3, 50, 500);
  chassis.turn_to_point(-34, -10, 0, 12, 2, 50, 750);
  pros::delay(150);
  chassis.drive_to_point(-34, -10, 6, 0, 2, 50, 1100);
  chassis.turn_to_point(-48, -24, 0, 12, 2, 50, 750);
  chassis.drive_to_point(-40.5, -16.5, 1.75, 0, 2.5, 50, 1000);
  chassis.drive_to_point(-28, -4, 10, 0);
  //pros::delay(100);
  chassis.drive_to_point(-34.5, -10.5, 12, 0, 2, 50, 750);
...
void redLeftElim(){
  ...
  pneumatics.clench_v(1);
  pros::delay(100);
  chassis.turn_to_point(-18, 40, 0, 10, 2, 50, 1000);
  scoring_mech.move1(0);
  scoring_mech.intake_move(600);
  chassis.drive_to_point(-18, 40, 10, 0);
  chassis.turn_to_point(-24, 40, 0, 12, 2, 10, 100);
  //pros::delay(150);
  chassis.drive_to_point(-24, 40, 10, 0);
  //pros::delay(200);

  chassis.turn_to_point(-24, 28, 0, 12, 2.5, 50, 750);
  chassis.drive_to_point(-24, 28, 12, 0, 3, 50, 500);
  chassis.turn_to_point(-32, -9, 0, 12, 2, 50, 750);
  chassis.drive_to_point(-33, -9, 12, 0, 2, 50, 1100);
  chassis.turn_to_point(-48, -25, 0, 12, 2, 50, 750);
  chassis.drive_to_point(-40.5, -17.5, 2, 0, 2.5, 50, 1000);
  chassis.drive_to_point(-27, -4, 10, 0);
  //pros::delay(100);
  chassis.drive_to_point(-32.5, -9.5, 12, 0, 2, 50, 750);
  chassis.drive_to_point(-24, -1, 12, 0, 3, 50, 600);
...
void redRightElim(){
  ...
  chassis.set_coordinates(0, 0, 0);
  pros::delay(500);
  chassis.turn_to_point(12.5, -2.5, 0, 5, 0.5, 250, 3000);
  pros::delay(500);
  chassis.drive_to_point(12.5, -2.5, 5, 0, 0.5, 250, 3000);
  pros::delay(500);
  ...
  chassis.drive_to_point(20, 16, 11, 1, 4, 50, 15000);
  pneumatics.doinker_left_v(0);
  pneumatics.doinker_right_v(1);
  chassis.turn_to_point(18.5, -2, 0, 8, 1.5, 100, 1000);
  ...
  scoring_mech.intake_move(600);
  chassis.drive_to_point(36, 0, 8, 2, 4, 50, 1000);
  pneumatics.clench_v(0);
  chassis.drive_to_point(48, -24, 3, 1.5, 1.5, 50, 1100);
  pros::delay(200);
  scoring_mech.intake_move(15);
  chassis.turn_to_point(48, -24);
  ...
  pneumatics.clench_v(1);
  pros::delay(100);
  chassis.turn_to_point(39.5, 39.5);
  pros::Task score_task(Scoring_Mech::neutral_stake_score_task);
  scoring_mech.intake_move(600);
  chassis.drive_to_point(39.5, 39.5, 10, 0, 2, 50, 1700);
  chassis.turn_to_point(48, 48.5, 0, 10, 1.5, 100, 850);
  ...
  //37.37, 38.191, 41.739
  /*chassis.turn_to_point(4, 48);
  scoring_mech.intake_move(600);
  chassis.drive_to_point(40, 12);
  pneumatics.clench_v(0);
  pros::delay(100);
  chassis.drive_to_point(20, 4, 7, 1.5);
  chassis.turn_to_point(48, -24);
  scoring_mech.intake_move(0);
  chassis.drive_to_point(0, 24, 8, 0.5);
  pros::delay(200);
  pneumatics.clench_v(1);
  scoring_mech.intake_move(600);
  chassis.drive_to_point(36, -12);*/
...
void blueLeftElim() {
  ...
  chassis.set_coordinates(0, 0, 0);
  pros::delay(500);
  chassis.turn_to_point(-13.5, -2.5, 0, 5, 0.5, 250, 3000);
  pros::delay(500);
  chassis.drive_to_point(-13.5, -2.5, 5, 0, 0.5, 250, 3000);
  pros::delay(500);
  chassis.turn_to_angle(342.512, 5);
  /*default_constants();
  ...
  chassis.set_coordinates(0, 0, 0);
  pros::delay(500);
  chassis.turn_to_point(-10.5, -10.5, 0, 5, 0.25, 300, 3000);
  pros::delay(500);
  chassis.drive_to_point(-10.5, -10.5, 5, 0.25, 0.25, 300, 3000);*/
  /*default_constants();
  chassis.set_coordinates(-10, -10, 225);
  chassis.drive_to_point(-16, -16, 6, 0.5, 2, 50, 700);
  scoring_mech.intake_move(600);
  pros::delay(350);
  scoring_mech.intake_move(10);
  chassis.drive_to_point(18, 18, 11, 0.25);
  chassis.drive_to_point(24, 24, 4, 0);
  pneumatics.clench_v(1);
  pros::delay(50);
  scoring_mech.intake_move(600);
  pros::delay(100);
  chassis.turn_to_point(41, 38, 0, 12, 2, 50, 1200);
  scoring_mech.intake_move(0);
  chassis.drive_to_point(41, 38);
  pneumatics.doinker_left_v(1);
  pros::delay(100);
  chassis.turn_to_point(46, 58.5);
  pneumatics.doinker_right_v(1);
  pros::delay(200);
  chassis.drive_to_point(20, 12, 8, 1.25);
  pneumatics.doinker_left_v(0);
  pneumatics.doinker_right_v(0);
  scoring_mech.intake_move(600);
  chassis.turn_to_point(34, 20);
  chassis.drive_to_point(34, 20);
  chassis.turn_to_point(0, 24);
  chassis.drive_to_point(0, 24, 8, 0.25, 2, 50, 2000);
  scoring_mech.intake_move(50);
  scoring_mech.set_up();
  chassis.turn_to_point(-15, 38);
  pros::delay(100);
  scoring_mech.intake_move(0);
  scoring_mech.score();
  chassis.drive_to_point(-15, 38);
  ...
  chassis.set_coordinates(-11.5, -2.493, 341.478);
  pros::Task rush_task(Scoring_Mech::rush_helper_task);
  chassis.drive_to_point(-23, 28, 12, 0, 2.5, 50, 2500, 0.65, 0, 0.5, 0, 0, 0, 0, 0);
  chassis.drive_to_point(-19, 16, 11, 1, 2, 50, 1500);
  pneumatics.doinker_right_v(0);
  pneumatics.doinker_left_v(1);
  chassis.turn_to_point(-17, 0);
  chassis.drive_to_point(-21, 32, 10, 0, 1, 50, 1000);
  pneumatics.doinker_left_v(0);
  pros::delay(100);
  pneumatics.clench_v(1);
  pros::delay(100);
  chassis.turn_to_point(-38, 0);
  scoring_mech.intake_move(600);
  chassis.drive_to_point(-38, 0);
  pneumatics.clench_v(0);
  chassis.drive_to_point(-44, -14, 6, 1, 1.5, 50, 950);
  pros::delay(500);
  scoring_mech.intake_move(25);
  chassis.turn_to_point(-48, -24);
  chassis.drive_to_point(-10, 14, 12, 0);
  chassis.drive_to_point(-4, 20, 5, 0);
  pneumatics.clench_v(1);
  pros::delay(50);
  chassis.turn_to_point(-48, 24);
  pros::Task score_task(Scoring_Mech::neutral_stake_score_task);
  scoring_mech.intake_move(600);
  chassis.drive_to_point(-39, 38, 6, 3, 1.5, 50, 1500);
  chassis.turn_to_point(-48, 49.5, 0, 10);
  scoring_mech.move1(100);
  pros::delay(500);
  scoring_mech.move1(0);*/
  ...
  chassis.set_coordinates(-11.5, -2.493, 341.478);
  pros::Task rush_task(Scoring_Mech::rush_helper_task);
  chassis.drive_to_point(-23, 28, 12, 0, 1, 50, 2500);
  chassis.drive_to_point(-19, 16, 10.5, 1.5, 2, 50, 1000);
  pneumatics.doinker_right_v(0);
  chassis.turn_to_point(-17, 0);
  chassis.drive_to_point(-21, 34, 10, 0.15, 1, 50, 1000);
  pros::delay(100);
  pneumatics.clench_v(1);
  pros::delay(200);
  chassis.turn_to_point(-38, 0);
  ...
  scoring_mech.intake_move(600);
  chassis.drive_to_point(-39, 38, 6, 3, 1.5, 50, 1500);
  chassis.turn_to_point(-48, 49.5, 0, 6);
  scoring_mech.move1(50);
  pros::delay(400);
  scoring_mech.move1(0);*/
}
