...
class Scoring_Mech{
    ...
    void rush_helper();
     static int neutral_stake_helper_task();
    void neutral_stake_helper();
     static int neutral_stake2_helper_task();
    void neutral_stake2_helper();
     static int neutral_stake3_helper_task();
    void neutral_stake3_helper();
    static int intake_helper_task();
    void intake_helper();
